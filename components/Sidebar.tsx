    ...
    <>
      ...
      <div className="mobile-header">
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
          ...
          <span className="sidebar-logo-text" style={{ fontSize: '1rem' }}>Oqqo'rg'on</span>
        </div>
      ...
      <aside className={`sidebar ${isOpen ? 'open' : ''}`}>
        ...
        <div className="sidebar-logo" style={{ justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.625rem' }}>
            <img src="/logo.jpeg" alt="Logo" style={{ width: 40, height: 40, borderRadius: '50%', objectFit: 'cover', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }} />
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <span className="sidebar-logo-text" style={{ fontSize: '1.05rem', lineHeight: 1.2 }}>Oqqo'rg'on</span>
              <span style={{ fontSize: '0.65rem', color: 'var(--text-muted)', fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.05em' }}>Gilam Yuvish</span>
            </div>
          </div>
